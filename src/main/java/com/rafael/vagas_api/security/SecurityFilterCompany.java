package com.rafael.vagas_api.security;

import com.rafael.vagas_api.providers.JWTProviderCompany;
...
public class SecurityFilterCompany extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if(header != null) {
           var subjectToken = this.jwtProviderCompany.validateToken(header);
